# Contributing to EssDiveSampleRF

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
EssDiveSampleRF. These guidelines are not strict rules.
...
The EssDiveSampleRF team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the EssDiveSampleRF technical leads
...
[issues]: https://github.com/heycatwonton/EssDiveSampleRF/issues/
[pulls]: https://github.com/heycatwonton/EssDiveSampleRF/pulls/
